...
def main():
 ...
 with tempfile.TemporaryDirectory(prefix='chihun-test-') as temp:
  ...
  source=ROOT/'plugin/skills/ben-ux-writing'
  for host in ['.agents','.claude']:
   target=base/host/'skills/ben-ux-writing'
  ...
  marker=base/'.claude/skills/ben-ux-writing/USER_EDIT.txt';marker.write_text('keep this edit')
  ...
  p2=Path(temp)/'preflight';(p2/'.claude/skills/ben-ux-writing').mkdir(parents=True)
  ...
  (p3/'.agents/skills/ben-ux-writing').symlink_to(real,target_is_directory=True)
